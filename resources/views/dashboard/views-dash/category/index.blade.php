        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{ __('Categories') }}</h6>
                ...
                <div class="modal-body">
                    ...
                    <form id="formCategoryAdd" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" id="addCategory">{{ __('Save') }}</button>
                    ...
                    <form id="formCategoryUpdate" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success"
                                id="updateCategory">{{ __('Update') }}</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-secondary" data-bs-dismiss="modal"
                        type="button">{{ __('Close') }}</button>
                    <button type="submit" class="btn btn-danger" id="deleteCategory">{{ __('Delete') }}</button>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ asset('dashboard/local/category.js') }}"></script>
@stop
